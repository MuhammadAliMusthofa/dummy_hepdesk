  ...
  <div class="col-7">
    <form action="/ssd/admin/search/10/" method="GET" id="ssd_form">
      ...
      <div class="dropdown input-group my-4 form-filter">
        ...
        <input class="form-control p-4 dropdown-toggle" data-display="static" type="text" id="dropdownMenuButton"
          data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" name="keluhan" />
        ...
        <div class="dropdown-menu p-4 w-100">
          <div class="form-group">
            ...
            <div class="d-flex justify-content-between">
              ...
              <div class="btn-group-toggle" data-toggle="buttons">
                <label class="btn btn-light border">
                  <input type="checkbox" id="perguruan_tinggi" name="perguruan_tinggi" value="PERGURUAN TINGGI">
                  Perguruan Tinggi
                </label>
              </div>
...
<div class="col-12 mt-3">
  ...
  <div class="modal" id="successAddModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
          ...
          <table class="table text-left table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="align-middle">
                  <div class="d-flex">
                    <a href="{{ route('detail.ssd', $datas->id_ssd)}} "><button type="button"
                        class="btn btn-primary mr-2"><i class="fas fa-search-plus"></i></button></a>
                    ...
                    @else
                    <a href data-href="{{ route('visible.ssd', $datas->id_ssd)}}" data-toggle="modal"
                      data-target="#visibleModal"><button type="button" class="btn btn-danger "><i
                          class="fas fa-eye-slash"></i></button></a>
                    @endif
          ...
          {{-- <div class="d-flex justify-content-center">
            <nav aria-label="Page navigation example ">
              <ul class="pagination align-items-center">
                ...
                <li class="page-item active "><a class=" page-link bg-light font-weight-bold border-0 " href="#">1</a>
                </li>
    ...
    <div class="modal" id="successHideModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
      aria-hidden="true">
      <div class="modal-dialog-centered" role="document">
        <div class="modal-content col-3 mx-auto">
    ...
    <div class="modal" id="successVisibleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
      aria-hidden="true">
      <div class="modal-dialog-centered" role="document">
        <div class="modal-content col-3 mx-auto">
    ...
    <div class="modal" id="hideModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
      aria-hidden="true">
      <div class="modal-dialog-centered" role="document">
        <div class="modal-content col-3 mx-auto">
    ...
    <div class="modal" id="visibleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
      aria-hidden="true">
      <div class="modal-dialog-centered" role="document">
        <div class="modal-content col-3 mx-auto">
