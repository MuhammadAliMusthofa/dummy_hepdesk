            ...
            <div id="accordion">
                <div class="card mb-3 border-0">
                    <div class="card-header rounded d-flex justify-content-between align-items-center px-4 py-3"
                        id="headingOne">
                        <p class="text-left font-weight-bold ">Bagaimana caranya melakukan cara dengan cara-cara yang
                            memiliki cara yang seharusnya dilakukan dengan baik dan benar?</p>
                ...
                <div class="card mb-3 border-0">
                    <div class="card-header rounded d-flex justify-content-between align-items-center px-4 py-3"
                        ...
                        <a class="btn btn-link" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true"
                ...
                <div class="card mb-3 border-0">
                    <div class="card-header rounded d-flex justify-content-between align-items-center px-4 py-3"
                        ...
                        <a class="btn btn-link" data-toggle="collapse" data-target="#collapseFour" aria-expanded="true"
