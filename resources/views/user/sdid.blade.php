...
<div class="row justify-content-center text-center">
    <div class="col-8">
        ...
        <div class="input-group my-4">
            <input type="text" class="form-control p-4" placeholder="Cari Keluhan" aria-label="Username" aria-describedby="basic-addon1">
        ...
        <div class="sdid">
            ...
            <div id="accordion">
                <div class="card mb-3 border-0">
                    <div class="card-header rounded d-flex justify-content-between align-items-center px-4 py-3" id="headingOne">
                        <p class="text-left font-weight-bold ">Bagaimana caranya melakukan cara dengan cara-cara yang memiliki cara yang seharusnya dilakukan dengan baik dan benar?</p>
